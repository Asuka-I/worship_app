...
worship2 = user2.worships.create!(category: "神社", prefecture_id: "20", address: "諏訪市中洲宮山1", place: "諏訪大社", content: "見応えがあり、社ごとに雰囲気が違ってゆっくり楽しめた。",
                                  date: "2021/09/13")
worship3 = user3.worships.create!(category: "寺", prefecture_id: "14", address: "大和市福田2176", place: "常泉寺", content: "彼岸花が咲き誇り、とても美しいお寺。河童さんが沢山いた！",
                                  date: "2021/09/08")
